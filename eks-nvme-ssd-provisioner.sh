...
SUBDIR=nvme
mkdir -p /pv-disks/$SUBDIR
mount -o defaults,noatime,discard,nobarrier --uuid $UUID /pv-disks/$SUBDIR
echo "Device $DEVICE / $UUID has been mounted to /pv-disks/$SUBDIR"
